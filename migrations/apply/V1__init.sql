CREATE TABLE IF NOT EXISTS "user" (id uuid PRIMARY KEY, "name" TEXT NULL, username TEXT NOT NULL, hashed_password TEXT NOT NULL, salt TEXT NOT NULL, email TEXT NULL, roles TEXT DEFAULT 'user' NOT NULL, avatar_url TEXT NULL, venmo TEXT NULL, created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL);
...
CREATE TABLE IF NOT EXISTS host (id SERIAL PRIMARY KEY, apex TEXT NOT NULL, "name" TEXT NULL, logo TEXT NULL, robots_txt TEXT NULL, is_redirect BOOLEAN NULL, disallowed TEXT[] NOT NULL, domains TEXT[] NOT NULL, junk_params TEXT[] NOT NULL);
ALTER TABLE host ADD CONSTRAINT host_apex_unique UNIQUE (apex);
CREATE TABLE IF NOT EXISTS "source" (id BIGSERIAL PRIMARY KEY, outlet_id INT NOT NULL, url TEXT NOT NULL, lead_title TEXT NULL, source_type INT NULL, attempted_at TIMESTAMP NOT NULL, CONSTRAINT fk_source_outlet_id__id FOREIGN KEY (outlet_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS article (id BIGSERIAL PRIMARY KEY, source_id BIGINT NOT NULL, headline TEXT NOT NULL, description TEXT NULL, image_url TEXT NULL, "section" TEXT NULL, keywords TEXT[] NULL, word_count INT NULL, is_free BOOLEAN NULL, thumbnail TEXT NULL, "language" TEXT NULL, comment_count INT NULL, accessed_at TIMESTAMP NOT NULL, published_at TIMESTAMP NULL, modified_at TIMESTAMP NULL, CONSTRAINT fk_article_source_id__id FOREIGN KEY (source_id) REFERENCES "source"(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
CREATE TABLE IF NOT EXISTS lead (id BIGSERIAL PRIMARY KEY, url TEXT NOT NULL, outlet_id INT NOT NULL, target_id BIGINT NULL, CONSTRAINT fk_lead_outlet_id__id FOREIGN KEY (outlet_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT, CONSTRAINT fk_lead_target_id__id FOREIGN KEY (target_id) REFERENCES "source"(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS lead_job (id BIGSERIAL PRIMARY KEY, feed_id INT NULL, lead_id BIGINT NOT NULL, headline TEXT NULL, is_external BOOLEAN NOT NULL, fresh_at TIMESTAMP NULL, CONSTRAINT fk_lead_job_feed_id__id FOREIGN KEY (feed_id) REFERENCES feed(id) ON DELETE RESTRICT ON UPDATE RESTRICT, CONSTRAINT fk_lead_job_lead_id__id FOREIGN KEY (lead_id) REFERENCES lead(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
CREATE TABLE IF NOT EXISTS lead_result (id BIGSERIAL PRIMARY KEY, lead_id BIGINT NOT NULL, "result" INT NOT NULL, attempted_at TIMESTAMP NOT NULL, CONSTRAINT fk_lead_result_lead_id__id FOREIGN KEY (lead_id) REFERENCES lead(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS author (id SERIAL PRIMARY KEY, bylines TEXT[] NOT NULL);
CREATE TABLE IF NOT EXISTS outlet_author (outlet_id INT, author_id INT, CONSTRAINT pk_outlet_author PRIMARY KEY (outlet_id, author_id), CONSTRAINT fk_outlet_author_outlet_id__id FOREIGN KEY (outlet_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT, CONSTRAINT fk_outlet_author_author_id__id FOREIGN KEY (author_id) REFERENCES author(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
