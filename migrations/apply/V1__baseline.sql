...
CREATE TABLE IF NOT EXISTS "source" (id BIGSERIAL PRIMARY KEY, host_id INT NOT NULL, url TEXT NOT NULL, title TEXT NULL, score INT NULL, source_type INT NULL, image_url TEXT NULL, thumbnail TEXT NULL, embed TEXT NULL, seen_at TIMESTAMP NOT NULL, accessed_at TIMESTAMP NULL, published_at TIMESTAMP NULL, CONSTRAINT fk_source_host_id__id FOREIGN KEY (host_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS source_score (id BIGSERIAL PRIMARY KEY, source_id BIGINT NOT NULL, score INT NOT NULL, scored_at TIMESTAMP NOT NULL, CONSTRAINT fk_source_score_source_id__id FOREIGN KEY (source_id) REFERENCES "source"(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
CREATE TABLE IF NOT EXISTS lead (id BIGSERIAL PRIMARY KEY, url TEXT NOT NULL, host_id INT NOT NULL, source_id BIGINT NULL, CONSTRAINT fk_lead_host_id__id FOREIGN KEY (host_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT, CONSTRAINT fk_lead_source_id__id FOREIGN KEY (source_id) REFERENCES "source"(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS article (id BIGSERIAL PRIMARY KEY, source_id BIGINT NOT NULL, headline TEXT NOT NULL, alternative_headline TEXT NULL, description TEXT NULL, cannon_url TEXT NULL, "section" TEXT NULL, keywords TEXT[] NULL, word_count INT NULL, is_free BOOLEAN NULL, "language" TEXT NULL, comment_count INT NULL, modified_at TIMESTAMP NULL, CONSTRAINT fk_article_source_id__id FOREIGN KEY (source_id) REFERENCES "source"(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
