...
CREATE TABLE IF NOT EXISTS page (id BIGSERIAL PRIMARY KEY, host_id INT NOT NULL, url TEXT NOT NULL, title TEXT NULL, content_type INT NULL, score INT NULL, feed_position INT NULL, image_url TEXT NULL, thumbnail TEXT NULL, embed TEXT NULL, content_word_count INT NULL, ok_response BOOLEAN DEFAULT FALSE NOT NULL, seen_at TIMESTAMP NOT NULL, accessed_at TIMESTAMP NULL, published_at TIMESTAMP NULL, modified_at TIMESTAMP NULL, location_id INT NULL, headline TEXT NULL, alternative_headline TEXT NULL, description TEXT NULL, cannon_url TEXT NULL, meta_section TEXT NULL, keywords TEXT[] NULL, word_count INT NULL, is_free BOOLEAN NULL, "language" TEXT NULL, comment_count INT NULL, article_type_huddle_id BIGINT NULL, summary TEXT NULL, "type" INT NOT NULL, category INT NOT NULL, news_type INT DEFAULT 0 NOT NULL);
