...
CREATE TABLE IF NOT EXISTS page (id BIGSERIAL PRIMARY KEY, host_id INT NOT NULL, location_id INT NULL, url TEXT NOT NULL, title TEXT NULL, content_type INT NULL, score INT NULL, feed_position INT NULL, image_url TEXT NULL, thumbnail TEXT NULL, embed TEXT NULL, cached_word_count INT NULL, ok_response BOOLEAN DEFAULT FALSE NOT NULL, headline TEXT NULL, alternative_headline TEXT NULL, description TEXT NULL, cannon_url TEXT NULL, meta_section TEXT NULL, keywords TEXT[] NULL, word_count INT NULL, is_free BOOLEAN NULL, "language" TEXT NULL, comment_count INT NULL, article_type_huddle_id BIGINT NULL, summary TEXT NULL, "type" INT NOT NULL, category INT NOT NULL, news_type INT DEFAULT 0 NOT NULL, seen_at TIMESTAMP NOT NULL, accessed_at TIMESTAMP NULL, published_at TIMESTAMP NULL, modified_at TIMESTAMP NULL);
...
CREATE TABLE IF NOT EXISTS lead_result (id BIGSERIAL PRIMARY KEY, lead_id BIGINT NOT NULL, "result" INT NOT NULL, attempted_at TIMESTAMP NOT NULL, strategy INT NULL);
CREATE TABLE IF NOT EXISTS page_content (page_id BIGINT, content_id BIGINT, CONSTRAINT pk_page_content PRIMARY KEY (page_id, content_id));
