...
CREATE TABLE IF NOT EXISTS "source" (id BIGSERIAL PRIMARY KEY, host_id INT NOT NULL, url TEXT NOT NULL, score INT NULL, source_type INT NULL, seen_at TIMESTAMP NOT NULL, CONSTRAINT fk_source_host_id__id FOREIGN KEY (host_id) REFERENCES host(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE INDEX article_published_at ON article (published_at);
