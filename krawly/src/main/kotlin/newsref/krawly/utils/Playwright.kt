...
private fun <T> tryNavigate(
	...
	return try {
		...
		if (message != null) {
			...
			if (message.contains("ERR_INTERNET_DISCONNECTED") && handleDisconnected != null)
				return handleDisconnected()
			if (message.contains("Request timed out") && handleTimeout != null)
